...
## Overview
The objective of this project is to build a facts-only FAQ assistant (RAG chatbot) specifically for a selected set of HDFC AMC mutual fund schemes, using Groww as the reference product context. The assistant will answer objective, verifiable queries related to these specific mutual funds by retrieving information exclusively from the provided Groww URLs.
...
### 1. Corpus Definition
- **Selected Asset Management Company (AMC):** HDFC AMC
- **Selected Mutual Fund Schemes:**
  ...
  - [HDFC Dividend Yield Fund Direct Growth](https://groww.in/mutual-funds/hdfc-dividend-yield-fund-direct-growth)
- Utilize exclusively the provided Groww URLs as the knowledge source.
...
### Data and Sources
- Use only the provided Groww URLs for scheme details.
- Do not use other third-party blogs, aggregators, or external websites.
